...
function renderDml(dml, options) {
    var _a, _b;
    const { tableOnly = false, ignoreEnums = false, includeRelationFromFields = false, } = options !== null && options !== void 0 ? options : {};
...
exports.default = async (options) => {
    ...
    try {
        ...
        fs_1.default.writeFileSync(tempConfigFile, JSON.stringify({
